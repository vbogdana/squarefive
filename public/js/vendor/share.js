...
Share = (function(superClass) {
  ...
  Share.prototype.inject_html = function(instance) {
    return instance.innerHTML = "<label class='entypo-export'><span>" + this.config.ui.button_text + "</span></label><div class='social load " + this.config.ui.flyout + "'><ul><li  class='twitter' data-network='twitter'><i class='fa fa-twitter'></i></li><li class='facebook' data-network='facebook'><i class='fa fa-facebook'></i></li><li class='gplus' data-network='google_plus'><i class='fa fa-google-plus'></i></li><li class='paper-plane' data-network='email'><i class='fa fa-envelope'></i></li></ul></div>";
  };
